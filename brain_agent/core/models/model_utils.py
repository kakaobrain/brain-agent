...
from brain_agent.utils.utils import log, AttrDict
...
def get_hidden_size(cfg, action_space):
    if cfg.model.core.core_type == 'trxl' and cfg.model.agent == 'dmlab_multitask_agent':
    ...
    elif cfg.model.core.core_type == 'trxl' and 'nethack' in cfg.model.agent:
        size = cfg.model.core.hidden_size * (cfg.model.core.n_layer + 1)
        ...
        size = cfg.model.core.hidden_size * cfg.model.core.n_rnn_layer
    else:
