...
class SharedBuffer:
    def __init__(self, cfg, obs_space, action_space):
        ...
        if self.cfg.model.agent == 'nethack_baseline_agent':
            ...
            policy_outputs.extend([
                ('atypes', 1),
                ('atype_logits', action_space['atype'].n),
                ('log_prob_atypes', 1),

                ('directions', 1),
                ('direction_logits', action_space['direction'].n),
                ('log_prob_directions', 1),

                ('spells', 1),
                ('spell_logits', action_space['spell'].n),
                ('log_prob_spells', 1),

                ('use_items', 1),
                ('use_item_logits', action_space['use_item'].n),
                ('log_prob_use_items', 1),

                ('pick_items', 1),
                ('pick_item_logits', action_space['pick_item'].n),
                ('log_prob_pick_items', 1),
            ])
